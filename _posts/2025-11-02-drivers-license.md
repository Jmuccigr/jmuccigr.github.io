---
title: "Getting my Italian driver's license: A saga for our times"
...
I should say first that Rome's equivalent of the DMV, the Motorization office (OK, *Motorizzazione Civile di Roma*, but I like the anglicized version), has a nice on-line page, with all sorts of info about the process. I needed to brush up on my bureaucratic Italian, but [the site](https://motorizzazioneroma.eu/item.php?catid=2&itemid=546) is really very helpful. About the only thing that's not so clear is the work hours of their office…as I found out the hard way one recent Tuesday (which is not a Monday, Wednesday, or Friday).
...
{% include image.html 
    srcabs="https://upload.wikimedia.org/wikipedia/commons/b/b5/Mission_Accomplished_banner_on_the_USS_Abraham_Lincoln_%28CVN-72%29_%281%29.jpg"   url="https://upload.wikimedia.org/wikipedia/commons/b/b5/Mission_Accomplished_banner_on_the_USS_Abraham_Lincoln_%28CVN-72%29_%281%29.jpg"
    caption="Mission accomplished<br>"
    alt="Mission accomplished sign from the G. W. Bush era"
    attribution="(U.S. Navy photo by Photographer's Mate 3rd Class Juan E. Diaz. (RELEASED), Public domain, via Wikimedia Commons)"
%}
